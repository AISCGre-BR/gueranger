      ...
      <div className="flex items-center gap-2">
        ...
        {row.original.sourceUrl && (
          <button
            ...
            title={`Open ${row.original.sourceDatabase} in browser`}
            aria-label={`Open ${row.original.sourceDatabase} in browser`}
    ...
    cell: ({ getValue }) => {
      ...
      return (
        <span
          ...
          title="Whether an image URL was accessible via API check. Absence does not confirm the image is unavailable."
        >
          {available ? (
            <>
